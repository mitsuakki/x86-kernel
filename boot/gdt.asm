; GDT (Global Descriptor Table) - flat memory model, 32-bit protected mode.
;
; Each descriptor is 8 bytes.  We need three entries:
;   0. Null descriptor (CPU requirement, catches null selectors)
;   1. Code segment (selector 0x08) - ring 0, executable, readable
;   2. Data segment (selector 0x10) - ring 0, writable
;
; Descriptor layout (64 bits):
;   bits 63:56 = base[31:24]
;   bits 55:52 = flags (4 bits: Gr Sz 0 0)
...
;   bit 2 = Sz (Size: 0 = 16-bit protected, 1 = 32-bit protected)
;   bits 1:0 = 0 (reserved)
;
; Flat model: base=0, limit=0xFFFFF (4 GiB with Gr=1), Sz=1 (32-bit).
